...
survey11_prompt5 = Prompt.create(question_id: question40.id, prompt: 'Create a blog and blog content')
...
survey11_prompt13 = Prompt.create(question_id: question41.id, prompt: 'Follow others')
survey11_prompt14 = Prompt.create(question_id: question41.id, prompt: 'Subscribe to groups and forums')
survey11_prompt15 = Prompt.create(question_id: question41.id, prompt: 'Check news updates')
survey11_prompt16 = Prompt.create(question_id: question41.id, prompt: 'Participate in online question and answering forums')
