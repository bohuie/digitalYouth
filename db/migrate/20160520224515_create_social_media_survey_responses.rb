class CreateSocialMediaSurveyResponses < ActiveRecord::Migration
  def change
    create_table :social_media_survey_responses do |t|
      t.integer :Q1_SQid, :Q1
   	  ...
   	  t.integer :Q24_SQid, :Q24
   	  t.integer :Q25_SQid, :Q25
   	  t.integer :Q26_SQid, :Q26
   	  t.integer :Q27_SQid, :Q27
   	  t.integer :Q28_SQid, :Q28
   	  t.integer :Q29_SQid, :Q29
   	  t.integer :Q30_SQid, :Q30
   	  t.integer :Q31_SQid, :Q31
   	  t.integer :Q32_SQid, :Q32
