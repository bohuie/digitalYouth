...
survey2_prompt6 = Prompt.create(question_id: question5.id, prompt: 'Use a browser to move forward and backward through webpages')
...
survey2_prompt16 = Prompt.create(question_id: question7.id, prompt: 'Use advanced search filters and strategies')
survey2_prompt17 = Prompt.create(question_id: question7.id, prompt: 'Connect to the internet using a cable')
survey2_prompt18 = Prompt.create(question_id: question7.id, prompt: 'Determine the IP address of a machine')
survey2_prompt19 = Prompt.create(question_id: question7.id, prompt: 'Check if a wireless network is secured')

survey2_prompt20 = Prompt.create(question_id: question8.id, prompt: 'Connect to a modem')
survey2_prompt21 = Prompt.create(question_id: question8.id, prompt: 'Configure a modem')
survey2_prompt22 = Prompt.create(question_id: question8.id, prompt: 'Connect to a wireless router')
survey2_prompt23 = Prompt.create(question_id: question8.id, prompt: 'Configure a wireless router')
survey2_prompt24 = Prompt.create(question_id: question8.id, prompt: 'Check activity status of a specific server')
survey2_prompt25 = Prompt.create(question_id: question8.id, prompt: 'Troubleshoot network connectivity problems')
...
survey3_prompt12 = Prompt.create(question_id: question12.id, prompt: 'Build complex websites with databases and modern interface')
survey3_prompt13 = Prompt.create(question_id: question11.id, prompt: 'Measure programs for performance')

survey3_prompt14 = Prompt.create(question_id: question12.id, prompt: 'Develop programs with necessary security measures')
survey3_prompt15 = Prompt.create(question_id: question12.id, prompt: 'Write and test programs that mimics mathematical models')
survey3_prompt16 = Prompt.create(question_id: question12.id, prompt: 'Write and test programs to run simulations and experiments')
survey3_prompt17 = Prompt.create(question_id: question12.id, prompt: 'Write and test third party apps for social media platform')
survey3_prompt18 = Prompt.create(question_id: question12.id, prompt: 'Optimize programs for performance')
...
survey8_prompt16 = Prompt.create(question_id: question31.id, prompt: 'Compare different pricing techniques')
...
survey10_prompt25 = Prompt.create(question_id: question39.id, prompt: 'Using or modifying media content without violating copyrights law')
...
survey11_prompt10 = Prompt.create(question_id: question41.id, prompt: 'Check news updates')
...
survey11_prompt19 = Prompt.create(question_id: question42.id, prompt: 'Develop text content for social media')
survey11_prompt20 = Prompt.create(question_id: question42.id, prompt: 'Develop images/video content for social media')
survey11_prompt21 = Prompt.create(question_id: question42.id, prompt: 'Engage others using social media')
survey11_prompt22 = Prompt.create(question_id: question42.id, prompt: 'Check up on competitors')
survey11_prompt23 = Prompt.create(question_id: question42.id, prompt: 'Buy paid ads')
survey11_prompt24 = Prompt.create(question_id: question42.id, prompt: 'Use tools to manage multiple channels (e.g. Hootsuite)')
survey11_prompt25 = Prompt.create(question_id: question42.id, prompt: 'Determine the credibility of a source and the reliability of information presented')

survey11_prompt26 = Prompt.create(question_id: question43.id, prompt: 'Moderate forums and disussions')
survey11_prompt27 = Prompt.create(question_id: question43.id, prompt: 'Incorporate social media as part of a larger campaign')
survey11_prompt28 = Prompt.create(question_id: question43.id, prompt: 'Develop social media plan according to business objectives')
survey11_prompt29 = Prompt.create(question_id: question43.id, prompt: 'Actively acquire followers')
survey11_prompt30 = Prompt.create(question_id: question43.id, prompt: 'Collect data about your customers or products')
...
survey11_prompt33 = Prompt.create(question_id: question43.id, prompt: 'Curating and citing other people\'s work without violating plagiarism')
