...
(function() {
  $(document).on("page:change", function() {
    ...
    $(window).scroll(function() {
      return checkScroll(15, 'ajax-loading', '/notifications');
    });
...
//Adds filter, and filter value to the url from the input
...
//Formats url as it should be in url
